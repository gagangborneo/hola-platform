...
export function SelectGroup({ ...props }: ComponentProps<typeof SelectPrimitive.Group>): ReactNode {
  return <SelectPrimitive.Group data-slot="select-group" {...props} />
}

export function SelectValue({ ...props }: ComponentProps<typeof SelectPrimitive.Value>): ReactNode {
...
export function SelectLabel({
  className,
  ...props
}: ComponentProps<typeof SelectPrimitive.Label>): ReactNode {
  return (
...
export function SelectSeparator({
  className,
  ...props
}: ComponentProps<typeof SelectPrimitive.Separator>): ReactNode {
  return (
